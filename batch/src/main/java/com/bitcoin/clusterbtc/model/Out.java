...
public class Out {
    ...
    private Long value;
    private List<SpendingOutpoint1> spending_outpoints = null;
    private Long n;
    ...
    public List<SpendingOutpoint1> getSpending_outpoints() {
        return spending_outpoints;
    }

    public void setSpending_outpoints(List<SpendingOutpoint1> spending_outpoints) {
    ...
    public String toString() {
        ...
        sb.append(Out.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("type");
        sb.append('=');
